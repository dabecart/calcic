...
Tested against [writing-a-c-compiler-tests](https://github.com/nlsandler/writing-a-c-compiler-tests) and [calcic-tests](https://github.com/dabecart/calcic-tests) repositories.
